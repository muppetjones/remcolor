...
#' @export
#' @examples
#' remcolor.simulate_colorblind_green(c("#005000","#008600","#00BB00"), border="light gray")
remcolor.simulate_colorblind_hex <- function(hex_str, cvd) {
    # algorithm from http://www.daltonize.org/
...
remcolor.simulate_colorblind_green <- function(col){
    return(sapply(col, function(x) simulate_colorblind_hex(x, CVDMatrix[['Deuteranope']])))
}
...
#' @export
#' @examples
#' remcolor.simulate_colorblind_red(c("#005000","#008600","#00BB00"), border="light gray")

remcolor.simulate_colorblind_red <- function(col){
    return(sapply(col, function(x) simulate_colorblind_hex(x, CVDMatrix[['Protanope']])))
}
...
#' @export
#' @examples
#' remcolor.simulate_colorblind_blue(c("#005000","#008600","#00BB00"), border="light gray")

remcolor.simulate_colorblind_blue <- function(col){
    return(sapply(col, function(x) simulate_colorblind_hex(x, CVDMatrix[['Tritanope']])))
}
