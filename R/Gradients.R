...
gradient.red2blue <- function(incr = 255) {
    ...
    B <- function(x) {
        1 / (1.579 - 4.03 * x
            + 12.92 * x^2 - 31.4 * x^3 + 48.6 * x^4 - 23.36 * x^5
            )
    }
    return(create_smooth_gradient(R, G, B, incr))
}
...
gradient.green2purple <- function() {
    palette <- c(
        "#005000", "#008600", "#00BB00", "#00F100", "#50FF50", "#86FF86",
        "#BBFFBB", "#FFFFFF", "#FFF1FF", "#FFBBFF", "#FF86FF", "#FF50FF",
...
gradient.brown2blue <- function() {
    palette <- c(
        "#331900", "#662F00", "#996035", "#CC9B7A", "#D8AF97", "#F2DACD",
        "#CCFDFF", "#99F8FF", "#65EFFF", "#32E3FF", "#00A9CC", "#007A99")
    return(palette)
}
...
gradient.gray2blue <- function() {
    palette <- c(
        "#2A2A2A", "#4B4B4B", "#656565", "#8F8F8F", "#B9B9B9", "#E5E5E5",
        "#CCFFFF", "#99FFFF", "#65EFFF", "#32D2FF", "#0098CC", "#006999")
    return(palette)
}
...
#' @param highlight The color to use as a highlight.
#'  Default is "red". Options are "green" or "blue".
#' @keywords colors palette
#' @export
#' @examples
